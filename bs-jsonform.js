        ...
        switch (json.field.type) {
            ...
            case "radio":
                ...
                json.field.optionskeys.forEach((item, index) => {
                    ...
                    <div class="custom-control custom-radio">
                        <input type="radio" id="`+id+index+`" name="`+id+`" value="`+Object.values(item)[0]+`" class="custom-control-input" `+isSelected+`>
                        <label class="custom-control-label" for="`+id+index+`">`+Object.keys(json.field.optionsvalues[index])[0]+`</label>
                    </div>`
                })
            ...
            case "select":
                ...
                json.field.optionskeys.forEach((item, index) => {
                    ...
                    template += `
                    <option `+isSelected+` value="`+Object.values(item)[0]+`">`+Object.keys(json.field.optionsvalues[index])[0]+`</option>`
                })
